...
//
//
//void GP2GraphicsPipeline3D::Initialize(const VulkanContext& vulkanContext, const VkFormat& swapChainImageFormat, const VkFormat& depthFormat)
//{
//	m_Shader.Init(vulkanContext);
//	CreateRenderPass(vulkanContext, swapChainImageFormat, depthFormat);
//	CreateGraphicsPipeline(vulkanContext.device);
//}
//
//void GP2GraphicsPipeline3D::UpdateMeshMatrix(const glm::mat4& model, size_t meshIndex)
//{
//	m_VecMeshes[meshIndex].SetModelMatrix(MeshData{ model });
//}
//
//void GP2GraphicsPipeline3D::UpdateUniformBuffer(uint32_t currentImage, glm::mat4 view, glm::mat4 projection)
//{
//	m_Shader.UploadUBOMatrix(view, projection);
//}
//
//void GP2GraphicsPipeline3D::Record(const GP2CommandBuffer& cmdBuffer, VkExtent2D vkExtent) const
//{
...
//}
//void GP2GraphicsPipeline3D::CreateRenderPass(const VulkanContext& vulkanContext, const VkFormat& swapChainImageFormat, const VkFormat& depthFormat)
//{
...
//}
//
//void GP2GraphicsPipeline3D::CreateGraphicsPipeline(const VkDevice& device) 
//{
...
//}
//void GP2GraphicsPipeline3D::AddMesh(const std::string& objFile, const MeshContext& meshContext)
//{
