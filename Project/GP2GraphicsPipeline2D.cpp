...
void GP2GraphicsPipeline2D::Initialize(const VkDevice& device, const VkFormat& swapChainImageFormat, GP2Shader2D& shader)
{
	CreateRenderPass(device, swapChainImageFormat);
	CreateGraphicsPipeline(device, shader);
}

void GP2GraphicsPipeline2D::CreateRenderPass(const VkDevice& device, const VkFormat& swapChainImageFormat)
{
...
void GP2GraphicsPipeline2D::CreateGraphicsPipeline(const VkDevice& device, GP2Shader2D& shader) 
{
...
void GP2GraphicsPipeline2D::AddRectangle(float top, float left, float bottom, float right,
...
void GP2GraphicsPipeline2D::AddRoundedRectangle(float top, float left, float bottom, float right, float radiusX, float radiusY, int numberOfSegmentsPerCorner,
	const VkPhysicalDevice& physicalDevice, const VkDevice& device, const GP2CommandPool& commandPool, VkQueue graphicsQueue)
{
	...
	const VkPhysicalDevice& physicalDevice, const VkDevice& device, const GP2CommandPool& commandPool, VkQueue graphicsQueue)
{
	...
	oval.UploadBuffers(physicalDevice, device, commandPool, graphicsQueue);
