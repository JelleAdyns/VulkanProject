...
void GP2GraphicsPipeline::Initialize(const VkDevice& device, const VkFormat& swapChainImageFormat, GP2Shader& shader)
{
...
VkPipeline GP2GraphicsPipeline::GetGraphicsPipeline() const
{
...
void GP2GraphicsPipeline::CreateGraphicsPipeline(const VkDevice& device, GP2Shader& shader) {
